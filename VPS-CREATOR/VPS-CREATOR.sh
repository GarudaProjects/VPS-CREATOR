...
msg -bar
echo -e "\033[97m"
echo -e "\033[41m -- INSTALLATION OF NECESSARY PACKAGES FOR VPS-MX -- "
echo -e "\033[100m  PAY ATTENTION TO INSTALLATION FOR THE FOLLOWING QUESTION"
echo -e "\033[97m"
msg -bar
#grep
...
[[ $(dpkg --get-selections|grep -w "net-tools"|head -1) ]] || ESTATUS=`echo -e "\033[91mINSTALLATION FAILURE"` &>/dev/null
[[ $(dpkg --get-selections|grep -w "net-tools"|head -1) ]] && ESTATUS=`echo -e "\033[92mINSTALLED"` &>/dev/null
...
[[ $(dpkg --get-selections|grep -w "curl"|head -1) ]] || ESTATUS=`echo -e "\033[91mINSTALLATION FAILURE"` &>/dev/null
[[ $(dpkg --get-selections|grep -w "curl"|head -1) ]] && ESTATUS=`echo -e "\033[92mINSTALLED"` &>/dev/null
...
msg -bar2
echo -e "\033[1;39m Press Enter To continue"
clear
### FIXEADOR PARA SISTEMAS 86_64
idfix64_86 () {
msg -bar2
echo -e "IN CASE OF REQUESTING ANY INSTALLATION, PLEASE CHOOSE: y "
...
clear
msg -bar2
echo -e "CHOOSE #All locals FIRST# Y LUEGO #en_US.UTF-8# " 
sleep 7s
...
msg -bar2
echo -e "\033[1;97m  ¿PRECENT ANY ERRORS ANY PREVIOUS PACKAGE?" 
msg -bar2
...
function_verify () {
  permited=$(curl -sSL "https://raw.githubusercontent.com/GarudaProjects/VPS-CREATOR/main/VPS-CREATOR/Control-IP")
  [[ $(echo $permited|grep "${IP}") = "" ]] && {
  echo -e "\n\n\n\033[1;95m======================================================\n ¡THIS KEY DOES NOT MATCH THE INSTALLER!, CONTACT @ Kalix1\n======================================================\n"
...
[[ $(find /etc/newadm/ger-user -name nombre.log|grep -w "nombre.log"|head -1) ]] || wget -O /etc/newadm/ger-user/nombre.log https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/nombre.log &>/dev/null
[[ $(find /etc/newadm/ger-user -name IDT.log|grep -w "IDT.log"|head -1) ]] || wget -O /etc/newadm/ger-user/IDT.log https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/IDT.log &>/dev/null
...
wget -O /bin/rebootnb https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/rebootnb &> /dev/null
chmod +x /bin/rebootnb 
wget -O /bin/resetsshdrop https://raw.githubusercontent.com/GarudaProjects/VPS-MX/main/VPS-MX_Oficial/ArchivosUtilitarios/resetsshdrop &> /dev/null
...
echo 'echo "" '>> .bashrc
echo 'echo -e "\033[92m        RESELLER : @GarudaProjects "'>> .bashrc
echo 'echo "" '>> .bashrc                                               
echo 'echo -e "\033[97m   TO DISPLAY BASH PANEL WRITE:  sudo menu "'>> .bashrc
echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/GarudaProjects/VPS-CREATOR/main/VPS-CREATOR/Version &>/dev/null'>> .bashrc
echo 'echo ""'>> .bashrc
...
NOTIFY () {
msg -bar
msg -ama " Notify-BOT (Remote Notification) | VPS-MX By @GarudaProjects "
msg -bar
echo -e "\033[1;94m It is an option to notify when \n a user is blocked or expired, and VPS info."
echo -e "\033[1;97m I must use the Telegram BOT @Noti_VPSMX_Bot"
echo -e "\033[1;92m To get your ID just put the command /MENU in the BOT @USA1_BOT"
echo -e "\033[1;92m A small menu will appear where your 👤 ID will appear"
msg -bar
echo -e "\033[1;97mEnter a name for the VPS:\033[0;37m"; read -p " " nombr
echo "${nombr}" > /etc/newadm/ger-user/nombre.log
echo -e "\033[1;97mEnter your ID 👤:\033[0;37m"; read -p " " idbot
...
KEY="1682958884:AAFRewSgn_rbPakHTT1-DGnpCBk9AJarGXc"
...
msg -ama "  \033[1;96m      🔰Using Ubuntu 18 to 64 Preferably🔰 "
msg -bar2
[[ $1 = "" ]] && funcao_idioma || {
[[ ${#1} -gt 2 ]] && funcao_idioma || id="$1"
 }
error_fun () {
msg -bar2 && msg -verm "VPS link ERROR<-->GENERADOR" && msg -bar2
[[ -d ${SCPinstal} ]] && rm -rf ${SCPinstal}
exit 1
}
invalid_key () {
msg -bar2 && msg -verm "#¡Key Invalid#! " && msg -bar2
[[ -e $HOME/lista-arq ]] && rm $HOME/lista-arq
exit 1
}
while [[ ! $Key ]]; do
msg -bar2 && msg -ne "# ENTER THE KEY #: " && read Key
tput cuu1 && tput dl1
done
msg -ne "# Verifying Key # : "
cd $HOME
wget -O $HOME/lista-arq $(ofus "$Key")/$IP > /dev/null 2>&1 && echo -e "\033[1;32m Full Key" || {
   echo -e "\033[1;91m Incomplete Key"
   invalid_key
   exit
   }
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   msg -bar2
   msg -verd "$(source trans -b es:${id} " INSTALLING"|sed -e 's/[^a-z -]//ig'): \033[1;31m[VPS-MX #MOD by @GarudaProjects]"
   REQUEST=$(ofus "$Key"|cut -d'/' -f2)
   [[ ! -d ${SCPinstal} ]] && mkdir ${SCPinstal}
   pontos="."
   stopping="$(source trans -b es:${id} "Checking Updates"|sed -e 's/[^a-z -]//ig')"
   ...
   echo -e "${cor[2]}         WANT TO INSTALL NOT-BOT?(Default n)"
   echo -e "\033[1;34m  (You must have Telegram and BOT: @Noti_VPSMX_Bot)"
   msg -bar2
   read -p " [ s | n ]: " NOTIFY   
